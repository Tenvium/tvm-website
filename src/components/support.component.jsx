  ...
  return (
    <div className="w-full mt-24">
      ...
      <div className="max-w-[1240px] text-white mx-auto relative px-10">
        <div className="px-4 py-12 -mb-32">
          <h2 className="text-4xl pt-8 font-bold text-slate-100  text-center">
             <strong className="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-blue-600">TVM CHAIN</strong> - Building The Future World
          </h2>
          <h3 className="text-2xl text-blue-600 py-6 text-center uppercase">
